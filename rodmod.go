...
func main() {
	...
	//page.MustElementX("//div[contains(text(), 'Welcome to ChatGPT') or contains(text(), 'Get started')]").MustWaitVisible()
	page.MustElementX("//div[not(contains(@class, 'mb-4')) and contains(text(), 'Log in')]").MustClick()
	page.MustElementX("//input[@id='username']").MustWaitVisible()
	page.MustElementX("//input[@id='username']").MustInput(chatgpt_user)
	page.MustElementX("//button[contains(text(), 'Continue')]").MustClick()
	page.MustElementX("//input[@id='password']").MustWaitVisible()
	...
	page.MustElementX("//a[contains(text(), 'New chat')]").MustWaitVisible()
	page.MustElementX("//a[contains(text(), 'New chat')]").MustClick()
	...
	//utils.Pause()
	//page.MustElementX(`//button//svg:path[@d="M.5 1.163A1 1 0 0 1 1.97.28l12.868 6.837a1 1 0 0 1 0 1.766L1.969 15.72A1 1 0 0 1 .5 14.836V10.33a1 1 0 0 1 .816-.983L8.5 8 1.316 6.653A1 1 0 0 1 .5 5.67V1.163Z"]`).MustClick()
	page.MustElement("svg path[d='M.5 1.163A1 1 0 0 1 1.97.28l12.868 6.837a1 1 0 0 1 0 1.766L1.969 15.72A1 1 0 0 1 .5 14.836V10.33a1 1 0 0 1 .816-.983L8.5 8 1.316 6.653A1 1 0 0 1 .5 5.67V1.163Z']").MustClick()
	//page.MustScreenshot("")
	page.MustScreenshot("")
	utils.Pause()
//	utils.Pause()
